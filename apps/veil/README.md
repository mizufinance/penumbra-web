...
Merges to main will automatically build a container, hosted at `ghcr.io/mizufinance/penumbra/apps/veil`.
...
Using https://buf.build/mizufinance/penumbra/sdks/main
