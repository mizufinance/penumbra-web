import { CandlestickDataResponse } from '@mizufinance/protobuf/penumbra/core/component/dex/v1/dex_pb';
import { PRICE_RELEVANCE_THRESHOLDS } from '@mizufinance/types/assets';
