...
client-side only apps. So we [migrated to React-Router](https://github.com/mizufinance/penumbra/pull/227).
...
The solution we had was to use React-Router's [hash router](https://github.com/mizufinance/penumbra/pull/372/files).
...
Afterward, we noticed [a few drawbacks to the hash router](https://github.com/mizufinance/penumbra/issues/310#issuecomment-1904608594).
