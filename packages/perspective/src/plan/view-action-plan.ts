...
import { getAuctionId } from '@mizufinance/wasm/auction';
import {
  getInputAssetId,
  getOutputAssetId,
} from '@mizufinance/getters/dutch-auction-description';
import {
...
import {
  DelegatorVotePlan,
  DelegatorVoteView,
} from '@mizufinance/protobuf/penumbra/core/component/governance/v1/governance_pb';
import {
  ActionLiquidityTournamentVotePlan,
  ActionLiquidityTournamentVoteView,
} from '@mizufinance/protobuf/penumbra/core/component/funding/v1/funding_pb';
  ...
  async (actionPlan: ActionPlan): Promise<ActionView> => {
    switch (actionPlan.action.case) {
      ...
      case 'ics20Withdrawal':
         ...
         * https://github.com/mizufinance/penumbra/issues/3614.
         */
        return new ActionView({
          actionView: {
            case: 'ics20Withdrawal',
