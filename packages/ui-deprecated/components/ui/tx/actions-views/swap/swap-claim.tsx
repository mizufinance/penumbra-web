...
import { SwapClaimView } from '@mizufinance/protobuf/penumbra/core/component/dex/v1/dex_pb';
...
import {
  ...
  getOutput2Value,
  getSwapClaimFee,
} from '@mizufinance/getters/swap-claim-view';
import { getAmount } from '@mizufinance/getters/value-view';
import { getAmount as getAmountFee } from '@mizufinance/getters/fee';
import { isZero, joinLoHiAmount } from '@mizufinance/types/amount';
