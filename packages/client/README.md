...
You can check this package in action in the [NextJS example repo](https://github.com/mizufinance/nextjs-penumbra-client-example) or read the [Architecture Decision Record (ADR-006)](https://github.com/mizufinance/penumbra/blob/main/docs/adrs/006-web-apis.md) describing the idea behind this package.
