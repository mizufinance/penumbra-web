...
import { AddressIndex, WalletId } from '@mizufinance/protobuf/penumbra/core/keys/v1/keys_pb';
import {
  PositionId,
  PositionState,
...
import type { IdbUpdate, PenumbraDb } from '@mizufinance/types/indexed-db';
import {
  AuctionId,
