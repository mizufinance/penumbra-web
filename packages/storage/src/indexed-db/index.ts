import { AppParameters } from '@mizufinance/protobuf/penumbra/core/app/v1/app_pb';
import {
  AssetId,
  EstimatedPrice,
  Metadata,
...
import {
  ...
  PositionState,
  TradingPair,
} from '@mizufinance/protobuf/penumbra/core/component/dex/v1/dex_pb';
import { GasPrices } from '@mizufinance/protobuf/penumbra/core/component/fee/v1/fee_pb';
import { Epoch, Nullifier } from '@mizufinance/protobuf/penumbra/core/component/sct/v1/sct_pb';
import { FmdParameters } from '@mizufinance/protobuf/penumbra/core/component/shielded_pool/v1/shielded_pool_pb';
import {
  AddressIndex,
  IdentityKey,
  WalletId,
...
import { StateCommitment } from '@mizufinance/protobuf/penumbra/crypto/tct/v1/tct_pb';
import {
...
import { assetPatterns, PRICE_RELEVANCE_THRESHOLDS } from '@mizufinance/types/assets';
...
import { bech32mIdentityKey, identityKeyFromBech32m } from '@mizufinance/bech32m/penumbravalid';
import { bech32mWalletId } from '@mizufinance/bech32m/penumbrawalletid';
import { getAssetId } from '@mizufinance/getters/metadata';
import { getIdentityKeyFromValidatorInfo } from '@mizufinance/getters/validator-info';
import { base64ToUint8Array, uint8ArrayToBase64 } from '@mizufinance/types/base64';
...
import {
  ...
  IndexedDbInterface,
  PenumbraDb,
} from '@mizufinance/types/indexed-db';
import type { Jsonified } from '@mizufinance/types/jsonified';
import type {
  ScanBlockResult,
  StateCommitmentTree,
} from '@mizufinance/types/state-commitment-tree';
import { sctPosition } from '@mizufinance/wasm/tree';
import {
  AuctionId,
  DutchAuctionDescription,
} from '@mizufinance/protobuf/penumbra/core/component/auction/v1/auction_pb';
import { ChainRegistryClient } from '@penumbra-labs/registry';
import { PartialMessage, PlainMessage } from '@bufbuild/protobuf';
import { getAmountFromRecord } from '@mizufinance/getters/spendable-note-record';
import { isZero } from '@mizufinance/types/amount';
import { IDB_VERSION } from './config.js';
import { addLoHi } from '@mizufinance/types/lo-hi';
...
export class IndexedDb implements IndexedDbInterface {
  ...
  async saveLQTHistoricalVote(
    ...
    // @see https://github.com/mizufinance/penumbra/issues/2032.
  ...
  private addSctUpdates(txs: IbdUpdates, sctUpdates: ScanBlockResult['sctUpdates']): void {
    ...
    // TODO: What about updates.delete_ranges (https://github.com/mizufinance/penumbra/issues/818)?
  }
