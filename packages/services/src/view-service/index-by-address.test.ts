...
import { IndexByAddressRequest } from '@mizufinance/protobuf/penumbra/view/v1/view_pb';
...
import { getAddressByIndex, getEphemeralByIndex } from '@mizufinance/wasm/keys';
