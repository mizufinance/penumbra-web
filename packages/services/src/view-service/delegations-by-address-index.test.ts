...
import { StakeService, ViewService } from '@mizufinance/protobuf';
import {
  createContextValues,
...
import { getAmount, getValidatorInfoFromValueView } from '@mizufinance/getters/value-view';
import { identityKeyFromBech32m } from '@mizufinance/bech32m/penumbravalid';
...
vi.mock('@mizufinance/wasm/metadata', () => ({
