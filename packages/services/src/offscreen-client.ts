...
import { ActionBuildMessage, OffscreenMessage } from '@mizufinance/types/internal-msg/offscreen';
import { InternalRequest, InternalResponse } from '@mizufinance/types/internal-msg/shared';
